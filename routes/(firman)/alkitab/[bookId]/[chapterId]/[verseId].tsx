    ...
    <div class="max-w-5xl mx-auto px-4 py-8">
      ...
      <div class="text-sm breadcrumbs mb-6">
        <ul>
          ...
          <li><a href={`/alkitab/${book.id}/${chapterId}`}>Pasal {chapterId}</a></li>
          <li>Ayat {verseId}</li>
        </ul>
      </div>
      ...
      <div class="flex justify-between mt-8 gap-4">
        ...
        <a href={`/alkitab/${book.id}/${chapterId}`} class="btn btn-ghost">
          Kembali ke Pasal
        </a>
      ...
      <div class="card bg-base-200 shadow-lg mt-8">
        <div class="card-body">
          ...
          <div class="flex flex-wrap gap-2">
            ...
            {totalVerses > 10 && (
              <a href={`/alkitab/${book.id}/${chapterId}`} class="btn btn-sm btn-outline">
