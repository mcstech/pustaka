...
export default define.page(function Home(ctx) {
  ...
  return (
    <div class="mx-auto max-w-5xl px-6 py-3 lg:px-8">
      <dl class="mt-20 divide-y divide-gray-900/10">
        {verses.map((verse) => (
          <div key={verse.id} class="py-8 first:pt-0 last:pb-0 lg:grid lg:grid-cols-12 lg:gap-8">
            ...
            <dd dir="rtl" class="mt-4 lg:col-span-7 lg:mt-0">
              <p class="text-base/7 text-gray-600 rtl:mr-3">
                {verse.text_uthmani}
              </p>
            </dd>
          </div>
