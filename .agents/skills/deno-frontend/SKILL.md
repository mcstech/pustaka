...
│   ├── index.tsx       # Home page (/)
│   └── (group)/        # Route groups with layouts
...
│   └── Button.tsx
├── libs/               # Shared utilities and logic
...
└── _fresh/             # Auto-generated build output (don't edit)
```
...
4. **Check version first** - To make sure solutions applied are using current convention
...
4. **Use `daisyui` class names** as it is convenient and prefer less javascript
